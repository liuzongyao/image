...
# not necessary
INTEGRATION_ENDPOINT = os.getenv("INTEGRATION_ENDPOINT", "http://54.222.236.194:666/")
INTEGRATION_USER = os.getenv("INTEGRATION_USER", "admin")
INTEGRATION_TOKEN = os.getenv("INTEGRATION_TOKEN", "87db6225603f0dc4e334b46b703bde46")
