...
def casename():
    casename_dict = {
        ...
        "test_jenkins_buildimage_updateservice": "检查Jenkins是否能访问-获取模板-创建集成中心实例-创建svn凭证-创建镜像仓库凭证-获取镜像地址-"
                                                 "创建Jenkins流水线项目-执行流水线-获取流水线执行状态-检查应用的"
                                                 "镜像版本是否更新成功-删除Jenkins流水线-删除集成中心实例-删除镜像版本",
        ...
        "test_log": "获取日志源-获取查询类型-获取时间统计-日志查询-创建查询条件-获取条件详情-搜索查询条件-获取查询条件列表-删除查询条件",
